...
- Nowadays, it could be easier with the use of `%>%` ("pipe") operator (**magrittr** or **dplyr** package)
...
- [Tidy data lesson using Lord of the Rings data](https://github.com/jennybc/lotr-tidy#readme)
