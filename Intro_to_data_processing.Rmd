...
- `spread()` function takes two columns (key & value) and spreads in to multiple columns (creates data in a "wide" format)
...
- `gather()` function reshape data from wide format to a long format
